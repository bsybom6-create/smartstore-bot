...
ALIGO_TEMPLATE_CODE = "UF_7303"  # 알리고 '템플릿 관리'에 있는 코드 (예: TM_1234)
MESSAGE_BODY = """#{고객명}님, #{상품명}을 주문해 주셔서 감사합니다. 아래 링크에서 가계부를 다운로드 해주세요. #{고객님}의 자산이 차곡차곡 쌓이길 응원하겠습니다❤️""" # 알리고에서 승인받은 '본문' 문구 그대로 입력
# ----------------------------------------------
